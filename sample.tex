...
\personalinfo{%
  ...
  \email{jobs@pdechamps.be}
  %\phone{000-00-0000}
  %\mailaddress{Allée de la découverte, 9 4000 Liège, Belgium}
  \location{Liège, BELGIUM}\\
  %\twitter{@twitterhandle}
  %\linkedin{linkedin.com/in/paul-dechamps-749072205/}
  \github{Paul-Dech}\\
  \homepage{www.uliege.be/cms/c_9054334/fr/repertoire?uid=u238419}
...
\cvevent{Teaching assistant}{University of Liege}{2022 -- Ongoing}{Liège, BELGIUM}
Main topics:
\begin{itemize}
...
\cvevent{Reasercher}{Embraer S.A.}{2022 -- Ongoing}{Liège, BELGIUM}
...
\cvevent{Ph.D.\ in Aerospace Engineering}{University of Liège}{March 2022 -- Ongoing}{}
...
\cvevent{M.Sc.\ in Aerospace Engineering}{University of Liège}{2022}{}
...
\cvachievement{\faLanguage}{Dutch}{Begginer}

\cvsection{Strengths}

\cvtag{\faCode~C++}
\cvtag{\faCode~Python}
\cvtag{\faFileCode~Matlab}
